        ...
        <div className="flex flex-col mb-4 rounded">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div
              ...
              className={`flex items-center px-4 py-2 border cursor-pointer gap-x-4 border-slate-400 rounded-xl ${active === "atm"
            ...
            <div
              ...
              className={`flex items-center px-4 py-2 border cursor-pointer gap-x-4 border-slate-400 rounded-xl ${active === "karyawan"
                ? "hover:bg-slate-200 bg-slate-100"
                : "bg-white hover:bg-slate-200"
                } transition-all duration-300`}
            >
            ...
            <div
              ...
              className={`flex items-center px-4 py-2 border cursor-pointer gap-x-4 border-slate-400 rounded-xl ${active === "asset"
                ? "hover:bg-slate-200 bg-slate-100"
                : "bg-white hover:bg-slate-200"
                } transition-all duration-300`}
            >
            ...
            <div
              ...
              className={`flex items-center px-4 py-2 border cursor-pointer gap-x-4 border-slate-400 rounded-xl ${active === "gap_scorings"
                ? "hover:bg-slate-200 bg-slate-100"
                : "bg-white hover:bg-slate-200"
                } transition-all duration-300`}
            >
