          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Cabang</span>
              </NavLink>
            </li>
            {/* Employees */}
            <li>
            ...
            <li>
              ...
              >
                <svg
                  className={`${
                    route().current("ops.sk-operasional")
                      ? `text-gray-900`
                      : `text-gray-500`
                  } flex-shrink-0 w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
                  aria-hidden="true"
            ...
            <li>
              <NavLink
                href={route("ops.apar")}
                active={route().current("ops.apar")}
                className="group"
              >
                <svg
                  className={`${
                    route().current("ops.apar")
                      ? `text-gray-900`
                      : `text-gray-500`
                  } flex-shrink-0 w-5 h-5 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white`}
                  aria-hidden="true"
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">APAR</span>
              </NavLink>
            </li>
            {/* <li>
              <a
